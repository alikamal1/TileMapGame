...
public class Player{
	...
	public Player(TileMap tm){
		...
		try{
			...
			idleSprites[0]=ImageIO.read(new File("pic/kirbyidle.gif"));
			jumpingSprites[0]=ImageIO.read(new File("pic/kirbyjump.gif"));
			fallingSprites[0]=ImageIO.read(new File("pic/kirbyfall.gif"));
			
			BufferedImage image=ImageIO.read(new File("pic/kirbywalk.gif"));
